-- видеоскрипт для плейлиста "Смотрёшка" https://smotreshka.tv (11/10/20)
...
-- https://smotreshka.tv/5dff7836b7ee6bd2ad034530
	...
	function smotreshkaSaveQuality_noAuto(obj, id)
		if id > 0 then
			m_simpleTV.Config.SetValue('smotreshka_qlty_noAuto', id)
		end
	end
