...
-- http://hls.peers.tv/streaming/rentv/126/vh1w/playlist.m3u8
	...
	local function getToken()
		...
		local rc, answer = m_simpleTV.Http.Request(session, {body = decode64('Z3JhbnRfdHlwZT1pbmV0cmElM0Fhbm9ueW1vdXMmY2xpZW50X2lkPTQzMjI0ODc5JmNsaWVudF9zZWNyZXQ9NDE4Yzk2ZDA0MTQ1MjRmYmJkMzgyMzI2YzM1OTY1YzY'), url = decode64('aHR0cDovL2FwaS5wZWVycy50di9hdXRoLzIvdG9rZW4='), method = 'post', headers = 'Content-Type: application/x-www-form-urlencoded'})
